...
import os
# import registration.config_keys as config_keys

BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

APP_DIR = os.path.join(BASE_DIR, 'zealicon_registration1')
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates'), os.path.join(BASE_DIR, 'regis/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
